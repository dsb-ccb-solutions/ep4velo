...
//	private static final String T_CTOOL = "ctool16";
	...
	// Define image names
	public static final String IMG_OBJ_SYSTEM_DIRECTIVE =
													"system_directive_obj.gif";
	public static final String IMG_OBJ_USER_DIRECTIVE =
													  "user_directive_obj.gif";
	...
	public static final ImageDescriptor DESC_OBJ_SYSTEM_DIRECTIVE =
								createManaged(T_OBJ, IMG_OBJ_SYSTEM_DIRECTIVE);
	public static final ImageDescriptor DESC_OBJ_USER_DIRECTIVE =
								  createManaged(T_OBJ, IMG_OBJ_USER_DIRECTIVE);
	public static final ImageDescriptor DESC_OBJ_MACRO =
										   createManaged(T_OBJ, IMG_OBJ_MACRO);
	/**
