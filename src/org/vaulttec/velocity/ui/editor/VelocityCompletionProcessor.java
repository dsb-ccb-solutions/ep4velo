...
public class VelocityCompletionProcessor implements IContentAssistProcessor {
	...
	private ICompletionProposal[] getDirectiveProposals(String aPrefix,
		...
		Iterator<VelocityMacro> macros = VelocityEditorEnvironment.getParser().
		...
		// Add user directives
		Iterator<String> userDirectives = VelocityEditorEnvironment.getParser().
	...
	private ICompletionProposal[] getVariableProposals(String aPrefix,
		...
		List<String> variables = fEditor.getVariables(fEditor.getLine(anOffset));
